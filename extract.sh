...
# Usage: ./extract.sh path/to/template.xml path/to/output/table {arff|csv|xml} {data-encoding} path/to/data.csv
# Extracts a new feature table with the same extraction settings as template.xml (any saved LightSide feature table or model)
